...
SVC_NAME="actions.runner.fiyinsomorin-demo-github-actions.Fiyins-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (fiyinsomorin-demo-github-actions.Fiyins-MacBook-Pro)"
